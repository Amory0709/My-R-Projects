...
# entry age LB
table(AIA_noUSD$EntryAge_LB)
AIA_noUSD$EntryAge_LB <- ifelse(AIA_noUSD$EntryAge_LB>=65, 65, as.integer(AIA_noUSD$EntryAge_LB))
table(AIA_noUSD$EntryAge_LB)
AIA_noUSD$EntryAge_LB<- as.factor(AIA_noUSD$EntryAge_LB)
...
nrow(subset(AIA_noUSD, is.na(AIA_noUSD$HI_Indicator))) #33096
